...
CREATE TABLE `SOCIAL_ACCOUNT`(
    ...
    CONSTRAINT sa_mno_fk FOREIGN KEY (`member_no`)
...
CREATE TABLE `MEMBER_AUTHORITY`(
    ...
    CONSTRAINT ma_mno_fk FOREIGN KEY (`member_no`)
        REFERENCES `MEMBER`(`no`),
    CONSTRAINT ma_ma_uk UNIQUE (`member_no`,`authority`)
)ENGINE=InnoDB
 DEFAULT CHARSET=utf8mb4
 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `MEMBER_GRADE`(
    ...
    CONSTRAINT mg_mno_fk FOREIGN KEY (`member_no`)
        REFERENCES `MEMBER`(`no`),
    CONSTRAINT mg_gr_uk UNIQUE (`member_no`)
)ENGINE=InnoDB
 DEFAULT CHARSET=utf8mb4
 COLLATE=utf8mb4_0900_ai_ci;
